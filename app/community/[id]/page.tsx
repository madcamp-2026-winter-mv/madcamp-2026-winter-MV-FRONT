                  ...
                  <CardHeader>
                    ...
                    {mockPost.isParty && isAuthor && isRecruiting && (
                      <p className="text-xs text-muted-foreground">
                        ...
                        <br />
                        <span className="text-destructive">익명 댓글 작성자는 선택할 수 없습니다.</span>
                      </p>
                    )}
                  </CardHeader>
                  <CardContent className="space-y-4">
                    ...
                    <form onSubmit={handleSubmitComment} className="space-y-3">
                      ...
                      <div className="flex items-center gap-2 ml-12">
                        ...
                        />
                        <Label htmlFor="commentAnonymous" className="text-sm text-muted-foreground cursor-pointer">
                          익명으로 작성
                          {mockPost.isParty && (
                            <span className="text-destructive ml-1">(익명 댓글은 참가자 선택 불가)</span>
                          )}
                        </Label>
                      </div>
                    </form>
